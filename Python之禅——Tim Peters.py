...
class MyFrame(wx.Frame):
    def __init__(self,parent,id):
        wx.Frame.__init__(self, parent, id, title = "Python之禅——Tim Peters",
        ...
        wx.StaticText(panel, label='可读性，很重要！',pos=(50,170))
        ...
        wx.StaticText(panel, label='命名空间是一种绝妙的理想，我们应当多加利用！',pos=(50,330))
